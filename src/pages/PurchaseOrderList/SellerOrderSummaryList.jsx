...
function SellerOrderSummaryList() {
  ...
  console.log("purchaseOrderDataSeller")
  ...
  return (
    <Paper
      ...
      elevation={0}
    >
      <BreadCrumbHeader MainText={"Seller Purchase order List"} />
      <Grid
        container
        sx={{
          background: "#FFFFFF",
      ...
      >
        ...
        <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
          ...
          {Switchtab === "Purchased" ? (
            <React.Fragment>
              {purchaseOrderDataSeller?.OrderSumm?.length > 0 &&
                purchaseOrderDataSeller?.OrderSumm?.map((data, idx) => {
...
export default SellerOrderSummaryList;
