...
export default function MobilityVoucherPrev() {
  ...
  return (
    <Paper
      ...
      elevation={0}
    >
      <BreadCrumbHeader MainText="Mobility Voucher" />
      <Box
        sx={{
          width: "95%",
          mx: "auto",
        ...
        <Grid container>
          ...
          <Grid item xl={6} lg={6} md={6} sm={12} xs={12}>
            <Box style={{ width: "632px" }}>
              {GetProductByIdData?.files && GetProductByIdData.files.length > 0 && <CarasoulForVoucherDetails imgSrc={GetProductByIdData?.files} />}
            </Box>
          </Grid>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  {ProductData?.ProductsVariantions && ProductData?.ProductsVariantions.length > 0 && ProductData?.ProductsVariantions[0]?.RoomType}
                </Typography>
                <Box
                  sx={{
                    display: "flex",
                ...
                >
                  ...
                  >
                    {/* 25.00/ Voucher */}
                    {ProductData?.ProductsVariantions && ProductData?.ProductsVariantions.length > 0 && ProductData?.ProductsVariantions[0]?.PricePerUnit} Voucher
                  </Typography>
                </Box>
              </Box>
              ...
              >
                <Grid item xl={8} lg={8} md={8} sm={8} xs={8}>
                  ...
                  >
                    {
                      ProductData && ProductData?.ProductsVariantions && ProductData.ProductsVariantions.length > 0 ?
                        <input
                          type="color"
                          value={ProductData.ProductsVariantions[0]['ProductColor']}
                          style={{
                            height: "40px",
                            width: "40px",
                            border: "1px",
                            borderColor: ProductData.ProductsVariantions[0]['ProductColor'],
                            cursor: "pointer",
                          }}
                          disabled
                        />
                  ...
                  <Typography sx={HeaderSubTypoStyle}>
                    {
                      ProductData && ProductData?.ProductsVariantions && ProductData.ProductsVariantions.length > 0 ?
                        <>
                          {ProductData.ProductsVariantions[0]['validityOfVoucher'] + " " + ProductData.ProductsVariantions[0]['validityOfVoucherUnit']}
                        </>
                        :
                        null
                    }
                    {/* {ProductData?.ProductsVariantions && ProductData?.ProductsVariantions.length > 0 && ProductData?.ProductsVariantions[0].validityOfVoucher ? : null + " " + ProductData?.ProductsVariantions && ProductData?.ProductsVariantions.length > 0 && ProductData?.ProductsVariantions[0]?.validityOfVoucherUnit}  */}
                  </Typography>
                </Grid>
              ...
              >
                    ...
                    >
                      {
                        ProductData && ProductData?.ProductsVariantions && ProductData.ProductsVariantions.length > 0 ?
                          <>
                            {ProductData.ProductsVariantions[0]['MinOrderQuantity']}
                          </>
                          :
                          null
                      }
                  ...
                  >
                    {
                      ProductData && ProductData?.ProductsVariantions && ProductData.ProductsVariantions.length > 0 ?
                        <>
                          {ProductData.ProductsVariantions[0]['MaxOrderQuantity']}
                        </>
                        :
                        null
                    }
                ...
                <Grid
                  ...
                  sx={VoucherDetailSecondGrid}
                >
                  <Typography sx={HeaderTypoStyle}>Price</Typography>
                  <Typography
                    sx={{
                      ...HeaderSubTypoStyle,
                      display: "flex",
