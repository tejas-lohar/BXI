                      ...
                      <>
                        ...
                        >
                          ...
                          >
                            ...
                            <Typography sx={CommonTypoStyle11}>
                              {ProductData.ProductsVariantions[0]["PricePerUnit"].toLocaleString("en-US")}
                            </Typography>
                          </div>
                          <div
                            style={{
                            ...
                            <table style={{ width: "100%" }}>
                              <thead>
                                <tr>
                                  ...
                                  {localStorage.getItem("companyType") === "Airlines Tickets" && <td className={classes.subTitle} >How can it be redeemed?</td>}
                                </tr>
                              </thead>
                              <tbody>
                                <tr>
                                  ...
                                  {localStorage.getItem("companyType") === "Airlines Tickets" && <td className={classes.titleDesc} >{ProductData?.redeemedValue && ProductData.redeemedValue == "Both" ? "Domestic & International" : ProductData.redeemedValue}</td>}
                                </tr>
                              </tbody>
                            </table>
                          </Box>
