...
const PI = (props) => {
  console.log("ProformaInvoice", props?.downloadpdf);
  const { id } = useParams();
  ...
  OrderSummarydata?.ProductData?.map((item) => {
    console.log("sdjgfuydfgudsygfugs", item);
  ...
  return (
    ...
    >
      <BreadCrumbHeader
        MainText={props?.Title || "Purchased Order"}
        PageName={props?.PageName || "Purchased order"}
      />
        ...
        <Box ref={componentRef}>
          ...
          >
            ...
            >
              ...
              >
                {props?.PageName || "Purchased order"}
              </Typography>
            </Box>
            <Box
              sx={{
              ...
              <Table sx={{ minWidth: "700px" }} aria-label="customized table">
                ...
                <TableBody>
                  {OrderSummarydata?.ProductData?.map((row, idx) => {
                    console.log("rowrowrowrow", row?.ProductTypeName);
                    let TotalSec = row?.TotalSec;

                    // let AdCostInrTotal = 0;
                    // let AdCostBxiTotal = 0;

                    // if (row?.AdditionCostArray?.length > 0) {
                    //   row?.AdditionCostArray.forEach((item) => {
                    //     if (item?.currencyType === "₹") {
                    //       AdCostInrTotal += item?.GstPrice;
                    //       totaladditionalcostinrupee += item?.TotalWithGst;
                    //     } else if (item?.currencyType === "BXITokens") {
                    ...
                    return (
                      <React.Fragment key={idx}>
                          ...
                          >
                            <Typography sx={TableBottomtext}>
                              <CommaSeprator
                                Price={
                                  row?.ProductTypeName !== "Media"
                                    ? row?.TotalPriceWithGSTInBXI?.toFixed(2)
                                    : row?.DiscountedPrice *
                                        row?.ProductQuantity *
                                        row?.BoughtSeconds *
                                        row?.TimelineToBought +
                        ...
                        {row?.AdditionCostArray?.map((res, index) => {
                          console.log("Additional Cost", res);
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                <Typography>
                                  <CommaSeprator Price={res?.PriceWithoutGST} />
                                </Typography>
                              </TableCell>
                              <TableCell
                                align="center"
              ...
              >
                ...
                >
                  ...
                  >
                    <NumberToWord
                      number={
                        Number(TotalTokanAmount) +
                        Number(totaltaxvalue) +
              ...
              >
                ...
                >
                  <TableRow sx={{ width: "100%", display: "flex" }}>
                    ...
                    >
                      <Typography sx={TableBottomtext}>
                        <CommaSeprator Price={TotalTokanAmount} />
                      </Typography>
                    </TableCell>
                  </TableRow>
                  <TableRow sx={{ width: "100%", display: "flex" }}>
