...
export default function LifestyleTechInfo() {
  ...
  const {
    ...
    resolver: zodResolver(
      z.object({
        Guarantee: z.coerce.number().min(1),
        GuaranteePeriod: z.string().min(1),
        Warranty: z.coerce.number().min(1),
    ...
    defaultValues: {
      Guarantee: "",
      Width: "",
      lengthMeasuriUnit: "cm",
      Length: "",
      heightMeasuriUnit: "cm",
      Height: "",
      WarrantyPeriod: "Year",
      Warranty: "",
      ...
      InstructionsToUseProduct: "",
      PackagingAndDeliveryInstructions: "",
      WeightAfterPackingPerUnitMeasurUnit: "Grams",
        ...
        },
        {
          onSuccess: (response) => {
            if (response.status === 200) {
              navigate(`/home/lifestyle/lifestylegolive/${ProductId}`);
            }
          },
          onError: (error) => {
            console.log("error", error);
            ...
            >
              ...
              <Box sx={{ display: "grid", gap: "10px", py: "20px" }}>
                ...
                <TextField
                  ...
                  rows={4}
                  variant="standard"
                  placeholder="Eg. Handle with care : delegate goods are inside the box "
                  InputProps={{
                    disableUnderline: "true",
                    style: {
                      color: "#445FD2",
              ...
              <Box sx={{ display: "grid", gap: "10px", py: "20px" }}>
                ...
                <TextField
                  ...
                  rows={4}
                  variant="standard"
                  placeholder="Eg. Office wear or casual wear, 2 hours of battery charge will last for entire day, do not hold product under water, etc  "
                  InputProps={{
                    disableUnderline: "true",
                    style: {
                      color: "#445FD2",
              ...
              <Box sx={{ display: "grid", gap: "10px", py: "20px" }}>
                ...
                <Box
                  ...
                  >
                <TextField
                  placeholder="Eg. Smart watch, Office wear watch, Casual wear watch, black colour watch etc."
                  sx={{
                    width: "100%",
                    background: "#fff",
                    borderRadius: "10px",
