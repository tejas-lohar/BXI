...
export default function ElectronicsVoucherInform(props) {
  ...
  const {
    ...
    resolver: zodResolver(
      z.object({
        ...
        TotalValueUploaded: z.coerce.number().optional(),
        length: z.string().optional(),
        width: z.string().optional(),
        height: z.string().optional(),
        ShoesSize: z.string().optional(),
    ...
    >
      {localStorage.getItem("digitalData") === "Offer Specific" ? (
        ...
        >
          ...
          />
          {errors?.TotalQuantity?.message ? generateError() : ""}
        </Box>
      )}
      ...
      {localStorage.getItem("digitalData") === "Offer Specific" ? (
        ...
        >
          <Typography sx={CommonTextStyle}>Total Value Uploaded</Typography>
          ...
          {errors?.TotalValueUploaded?.message ? generateError() : ""}
        </Box>
      )}
        ...
        <Button
          ...
          onClick={async () => {
            ...
            if (
              ...
              } else if (props.size === "ShoesSize") {
                setValue(
                  "ShoesSize",
                  `${getValues().ShoesSize}${getValues().measureMentUnit}`
                );
              }
  ...
  switch (props.size) {
    ...
    case "ShoesSize":
      return (
        ...
        >
          <Typography sx={CommonTextStyle}>Shoes Size</Typography>
