...
const EntertainmentEventGeneralInformation = () => {
  ...
  const tableRowFields = localStorage.getItem("digitalData") === "Offer Specific" ?
    [
      ...
      { label: 'Date of the event', value: 'DateOfTheEvent' },
    ...
    const fetchData = async () => {
      try {
        const response = await axios
          .get(`entertainmentfeature/Get_enter_feature`, {
            withCredentials: true,
          })
          .then((res) => {
            fetchHsnCode(res.data?.ProductSubCategory);
                    ...
                    <Box sx={boxStyle19}>
                      ...
                      >
                        {AllFeature?.map((el) => {
                          return (
                            <MenuItem
                              key={el.EntertainmentFeature}
                              value={el.EntertainmentFeature}
                              sx={CommonTextStyle}
                            >
                              <Typography sx={{
                                color: "#445fd2",
...
export default EntertainmentEventGeneralInformation;
