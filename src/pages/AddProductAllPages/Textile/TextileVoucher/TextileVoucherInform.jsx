...
export default function TextileVoucherInform(props) {
  ...
  const schema = z.object({
    ...
    ProductSize: z.any(),
    GST: z.coerce.number().min(1).max(28, "GST can not be greater than 28%"),
    ...
    height:
      props.size === "Length x Height" ||
        ...
        ? z.string().min(1)
        : z.string().optional(),
    measureMentUnit: localStorage.getItem("digitalData") === "Offer Specific" ? z.string().min(1, "Please select Unit.") : z.any(),
    listPeriod: z.any(),
  })
