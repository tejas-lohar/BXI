...
import MediaOfflineExcelSheet from "../../../../assets/ExelSheets/Media_Offline_Final (1).xlsx";
          ...
          >
            ...
            >
              ...
              >
                ...
                <Box
                  component={"a"}
                  download="mediaofflineDocs"
                  target="_blank"
                  href={MediaOfflineExcelSheet}
                  onClick={() => {
                    console.log("download excel");
                  }}
                  sx={downLoadText}
              ...
              <Box
                component={"a"}
                download="mediaofflineNewsPaper"
                target="_blank"
                href={MediaOfflineNewspaper}
                onClick={() => {
                  console.log("download excel");
                }}
                sx={downLoadText}
              >
              Download Format Template for NewsPaper{" "}
              </Box>
