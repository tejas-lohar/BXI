...
import OfficeSupplyExcelSheet from "../../../../assets/ExelSheets/BXI_Product_Sheet_Of_Office_Supply.xlsx";
...
const OfficeSupplyBulkUploadPage = () => {
          ...
          >
            ...
            >
              ...
              >
                ...
                <Box
                  component={"a"}
                  download="officesupplyDocs"
                  target="_blank"
                  href={OfficeSupplyExcelSheet}
                  onClick={() => {
                    console.log("download excel");
                  }}
                  sx={downLoadText}
...
export default OfficeSupplyBulkUploadPage;
const mainTextStyle = {
  fontFamily: "Poppins",
  fontStyle: "normal",
  fontWeight: 600,
