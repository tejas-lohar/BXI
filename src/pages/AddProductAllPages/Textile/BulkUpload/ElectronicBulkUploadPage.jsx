...
import ElectronicExcelSheet from "../../../../assets/ExelSheets/BXI_Product_Sheet_Of_Electronics.xlsx";
...
const ElectronicBulkUploadPage = () => {
          ...
          >
            ...
            >
              ...
              >
                ...
                <Box
                  component={"a"}
                  download="electronicDocs"
                  target="_blank"
                  href={ElectronicExcelSheet}
                  onClick={() => {
                    console.log("download excel");
                  }}
                  sx={downLoadText}
...
export default ElectronicBulkUploadPage;
const mainTextStyle = {
  fontFamily: "Poppins",
  fontStyle: "normal",
  fontWeight: 600,
