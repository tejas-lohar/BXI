...
import percentage from "../../../../assets/Images/VoucherJourney/VoucherInformation/Percentage.svg";
...
function Voucherinfo() {
  ...
  const Submit = (e) => {
    ...
    if (
      gst.trim() ||
      validityofvoucher.trim() ||
      minorderquantity.trim() ||
      maxorderquantity.trim() ||
      mrp.trim() ||
      totalquantity.trim() ||
      totalprice.trim() !== ""
    ) {
  ...
  const Editdata = (index) => {
    ...
    setvouchervalidity(selectItem.vouchervalidity);
  ...
  const secondSubmit = (e) => {
    e.preventDefault();
    const newitems = { othercostifapplicable, reasonofcost, payment };
    if (
      othercostifapplicable.trim() ||
      reasonofcost.trim() ||
      payment.trim() !== ""
    ) {
  ...
  const secondhandleEdit = (index) => {
    const selectitem = data[index];
    setOthercostifapplicable(selectitem.othercostifapplicable);
    setReasonofcost(selectitem.reasonofcost);
    setPayment(selectitem.payment);
    const NewItem = [...data];
    NewItem.splice(index, 1);
    setdata(NewItem);
  };

  const secondhandleDelete = (index) => {
    const NewItem = [...data];
    NewItem.splice(index, 1);
    setdata(NewItem);
  };
              ...
              <Box sx={{ marginTop: "2rem" }}>
                ...
                >
                  <Table aria-label="simple table">
                    <TableHead>
                      <TableRow>
                        <TableCell sx={tableheading}> MRP</TableCell>
                    ...
                    <TableBody>
                      {detail.map((item, index) => (
                        <TableRow key={item.name}>
                          ...
                          <TableCell align="center" sx={TableCellcss}>
                            {item.validityofvoucher} {item.vouchervalidity}
                          </TableCell>
                          <TableCell align="center" sx={TableCellcss}>
              ...
              {data.map((items, index) => {
                return (
                  ...
                  >
                    ...
                    >
                      {items.payment} {items.othercostifapplicable}
                    </Box>
                    ...
                    >
                      ...
                      <Box>
                        <Button onClick={() => secondhandleEdit(index)}>
                          <CreateIcon
                            sx={{ color: "#445FD2", width: "25px" }}
                          />
                        </Button>
                        <Button onClick={() => secondhandleDelete(index)}>
                          <CloseIcon sx={{ color: "#445FD2", width: "25px" }} />
                        </Button>
                      </Box>
                    </Box>
                  </Typography>
        ...
        >
          ...
          <Box sx={{ display: "flex", gap: "10px", p: 1, width: "50%" }}>
            ...
            <Button
              ...
              //   onClick={AddProduct}
              onClick={() => {
                navigate("/home/myproduct/vouchertechnicalinfo");
              }}
            >
              Next
