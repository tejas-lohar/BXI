  ...
  return (
    ...
    >
      ...
      >
        ...
        {errors?.MRP?.message ? generateError() : ""}
      </Box>
      ...
      {localStorage.getItem("digitalData") === "Offer Specific" ? (
        <>
          ...
          >
            ...
            {errors?.DiscountedPrice?.message ? generateError() : ""}
          </Box>
          <Box
            sx={{
              display: "flex",
          ...
          >
            ...
            />
            {errors?.ProductIDType?.message ? generateError() : ""}
          </Box>
        </>
      ) : (
        <Box
