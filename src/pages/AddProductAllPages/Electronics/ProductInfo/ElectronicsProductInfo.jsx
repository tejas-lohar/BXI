...
const ElectronicsProductInfo = () => {
  ...
  const updateProductTotextilestatus = handleSubmit((data) => {
    ...
    } else if (ProductUpdatedata.ProductFeatures.length > 25) {
                  ...
                  return (
                    ...
                    <Box>
                      ...
                      <TextField
                        focused
                        multiline
                        placeholder="Eg. Smart TWS Earbuds with LED Display, 15 Hrs Playtime, Bluetooth 5.2, Music & Game Modes, Voice Assistance (Black)Type in two - three words"
                        variant="standard"
