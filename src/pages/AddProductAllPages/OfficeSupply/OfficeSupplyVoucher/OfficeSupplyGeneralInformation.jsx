...
const OfficeSupplyGeneralInformation = () => {
    ...
    updateProduct(ProductUpdatedata, {
      onSuccess: (response) => {
        if (response.status === 200) {
          navigate(`/home/officesupplyVoucher/officesupplytechinfo/${id}`);
        }
      },
      onError: (error) => {
        console.log("error", error);
...
export default OfficeSupplyGeneralInformation;
