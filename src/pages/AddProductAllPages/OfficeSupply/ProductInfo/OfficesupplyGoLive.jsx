...
export default function TextileGoLive() {
  ...
  const uploadData = async (event) => {
    ...
    if (Number(ListPeriod) > maxDays) {
      // alert("Please select the list period less than 365 days");
      return toast.error(
        "Please select the list period less than " + { maxDays } + " Days",
        {
          position: "top-center",
          autoClose: 5000,
          hideProgressBar: false,
      ...
      <form>
        ...
        >
          ...
          >
            ...
            >
              Important Picture : ( Size Chart / Dimensions/ Certificate /
              Technical Information ) Add Here +
            </Typography>
          </Box> */}
            <input
              type="file"
