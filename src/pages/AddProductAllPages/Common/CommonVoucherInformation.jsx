...
import { useUpdateProductQuery } from "../Textile/TextileVoucher/ProductHooksQuery";
...
const CommonVoucherInformation = () => {
        ...
        updateProduct(ProductUpdatedata, {
            onSuccess: (response) => {
                if (response.status === 200) {
                    navigate(`/home/textileVoucher/textiletechinfo/${id}`);
                }
            },
            onError: (error) => {
                console.log("error", error);
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <Typography
                                                            sx={{
                                                                color:
                                                                    size === "Amplification" ? "#445fd2" : "#ADB8CC",
                                                                fontSize: "1.2rem",
                                                                textAlign: "center",
                                                            }}
                                                        >
                                                    ...
                                                    >
                                                        <Typography
                                                            sx={{
                                                                color: size === "Frequency" ? "#445fd2" : "#ADB8CC",
                                                                fontSize: "1.2rem",
                                                                textAlign: "center",
                                                            }}
                                                        >
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <TableCell align="center" sx={TableCellStyle}>
                                                                            {item.validityOfVoucherValue} &nbsp; {item.validityOfVoucherUnit}
                                                                        </TableCell>
                                        ...
                                        <Box sx={boxStyle19}>
                                            ...
                                            >
                                                {AllFeature?.map((el) => {
                                                    return (
                                                        <MenuItem
                                                            key={el.TextileFeature}
                                                            value={el.TextileFeature}
                                                            sx={CommonTextStyle}
                                                        >
                                                            <Typography sx={{
                                                                color: "#445fd2",
...
export default CommonVoucherInformation;
