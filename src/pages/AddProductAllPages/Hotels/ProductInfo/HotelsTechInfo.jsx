      ...
      updateProduct(formData, {
        onSuccess: (response) => {
          if (response.status === 200) {
            navigate(`/home/vouchers/voucherdesign/${ProductId}`);
          }
        },
      });
    }
        ...
        >
          ...
          <Box sx={{ display: "grid", gap: "10px", py: "10px" }}>
            ...
            <TextField
              ...
              sx={{
                ...textfieldstyle,
                border: errors["Inclusions"] ? "1px solid red" : null,
              }}
            />
          ...
          <Box sx={{ display: "grid", gap: "10px", py: "10px" }}>
            ...
            <TextField
              ...
              sx={{
                ...textfieldstyle,
                border: errors["Exclusions"] ? "1px solid red" : null,
              }}
            />
            <Typography sx={ErrorStyle}>
          ...
          <Box sx={{ display: "grid", gap: "10px", py: "10px" }}>
            ...
            <TextField
              ...
              sx={{
                ...textfieldstyle,
                border: errors["TermConditions"] ? "1px solid red" : null,
              }}
            />
            <Typography sx={ErrorStyle}>
          ...
          <Box>
            ...
            <TextField
              ...
              sx={{
                ...textfieldstyle,
                border: errors["RedemptionSteps"] ? "1px solid red" : null,
              }}
            />
            <Typography sx={ErrorStyle}>
